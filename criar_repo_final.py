#!/usr/bin/env python3
"""
Script para criar repositório no GitHub usando o token fornecido
"""
...
def criar_repositorio_github():
    ...
    # Token fornecido (removido por segurança)
    ...
    try:
        ...
        if response.status_code == 201:
            ...
            try:
                ...
                print(f"🔗 Acesse: https://github.com/{user_info['login']}/ufit-sales-agent")
                return True
